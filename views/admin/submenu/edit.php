...
<head>
    ...
    <title>Edit Submenu - Admin Dashboard</title>
...
<div class="content">
    <div class="page-header">
        <h2><i class="bi bi-pencil-square me-2"></i>Edit Submenu</h2>
    </div>

    <div class="form-container">
        <div class="form-card">
            <h3 class="form-title">Edit Data Submenu</h3>
            ...
            <form method="POST" action="../../../controllers/submenu.php">
                        ...
                        <div class="row g-3">
                            <?php foreach ($icons as $icon): ?>
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <label class="icon-option d-block <?= $submenu['icon_class'] === $icon ? 'selected' : '' ?>">
                                        <input type="radio" name="icon_class" value="<?= $icon ?>" <?= $submenu['icon_class'] === $icon ? 'checked' : '' ?>>
                                        <i class="bi <?= $icon ?>"></i>
                                    </label>
                                </div>
                            <?php endforeach; ?>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" name="update" class="btn btn-primary">
                        <i class="bi bi-save"></i> Update Submenu
                    </button>
                </div>
            </form>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Icon selection
        const radios = document.querySelectorAll('input[name="icon_class"]');
